defmodule TamanoirWeb.Router do
  use TamanoirWeb, :router

  import TamanoirWeb.UserAuth
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: TamanoirWeb.Telemetry
    end
  end
  ...
  scope "/", TamanoirWeb do
    ...
    get "/companies/", Company.CompanyController, :index
    get "/companies/new", Company.CompanyController, :new
    post "/companies/new", Company.CompanyController, :create
